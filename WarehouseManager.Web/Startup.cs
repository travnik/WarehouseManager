...
namespace WarehouseManager.Web
{
    public class Startup
    {
        public const string EnvironmentTestName = "UnitTest";
        ...
        {
            services.ConfigureWarehouseManagement(Configuration);
        ...
        {
            app.WarehouseInitializeDatabase();
